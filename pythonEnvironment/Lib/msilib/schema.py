...
('BBControl','Text','Y',None, None, None, None, 'Text',None, 'A string used to set the initial test contained within a control (if appropriate).',),
...
('Feature','Description','Y',None, None, None, None, 'Text',None, 'Longer descriptive test describing a visible feature item.',),
...
('Feature','Title','Y',None, None, None, None, 'Text',None, 'Short test identifying a visible feature item.',),
...
('ComboBox','Text','Y',None, None, None, None, 'Formatted',None, 'The visible test to be assigned to the item. Optional. If this entry or the entire column is missing, the test is the same as the value.',),
...
('Control','Text','Y',None, None, None, None, 'Formatted',None, 'A string used to set the initial test contained within a control (if appropriate).',),
...
('Control','Help','Y',None, None, None, None, 'Text',None, 'The help strings used with the button. The test is optional. ',),
...
('Dialog','Title','Y',None, None, None, None, 'Formatted',None, "A test string specifying the title to be displayed in the title bar of the dialog's window.",),
...
('LaunchCondition','Description','N',None, None, None, None, 'Formatted',None, 'Localizable test to display when condition fails and install must abort.',),
...
('ListBox','Text','Y',None, None, None, None, 'Text',None, 'The visible test to be assigned to the item. Optional. If this entry or the entire column is missing, the test is the same as the value.',),
...
('ListView','Text','Y',None, None, None, None, 'Text',None, 'The visible test to be assigned to the item. Optional. If this entry or the entire column is missing, the test is the same as the value.',),
...
('Media','DiskPrompt','Y',None, None, None, None, 'Text',None, 'Disk name: the visible test actually printed on the disk.  This will be used to prompt the user when this disk needs to be inserted.',),
...
('RadioButton','Help','Y',None, None, None, None, 'Text',None, 'The help strings used with the button. The test is optional.',),
...
('Verb','Command','Y',None, None, None, None, 'Formatted',None, 'The command test.',),
]
